...
| `/about` | Bio, skills, education, certifications, writing |
| `/skills` | Interactive tech stack node graph + skill grid |
| `/projects` | Featured and expandable project showcase |
| `/consulting` | Freelance services, case studies, CTA |
| `/tutoring` | Programming tutoring subjects, format, CTA |
...
- Responsive design (mobile-first, adaptive nav)
- Keyboard accessible with focus-visible indicators
- Skip-to-content link for screen readers
- Semantic HTML with ARIA landmarks
- Form validation with honeypot, inline error/success states
- Reduced motion support (`prefers-reduced-motion`)
- Smooth page transitions with Framer Motion
- Lazy-loaded Three.js backgrounds (IntersectionObserver)
- RK brand logo across navbar, 404, and loading states
- JSON-LD structured data (Person, WebSite, ProfessionalService, Course)
...
- Dynamic OG image with brand gradient
...
- Lazy-loaded Three.js backgrounds via IntersectionObserver
- Deferred Vercel Analytics (loaded after hydration)
- `optimizePackageImports` for lucide-react, react-icons, framer-motion
- Geometry/material disposal on component unmount (memory cleanup)
